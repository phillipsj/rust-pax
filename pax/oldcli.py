...
@pax.command()
@click.argument('tool')
@click.option('--versions', help='Which versions are available.')
@click.option('--installed', help='Which versions are installed.')
def list(tool, installed):
    '''List avialable versions and installed versions'''

    click.echo('Called list Terraform')
